...
ESPTab:Toggle("碎片ESP", "Scrap_ESP", loadData.scrapESP, function(newValue)
...
ESPTab:Toggle("补给箱ESP", "Supply_Drop_ESP", loadData.supplydropESP, function(newValue)
...
ESPTab:Toggle("玩家ESP", "Players_ESP", loadData.playerESP, function(newValue)
...
ESPTab:Toggle("信号枪ESP", "Flare_Gun_ESP", loadData.flaregunESP, function(newValue)
...
ESPTab:Toggle("信号枪通知", "Flare_Gun_Notifications", loadData.flaregunNotification, function(newValue)
...
VisualsTab:Toggle("无雾", "No_Fog", loadData.nofog, function(newValue)
...
VisualsTab:Toggle("始终白天", "Always_Day", loadData.alwaysDay, function(newValue)
...
VisualsTab:Toggle("始终夜晚", "Always_Night", loadData.alwaysNight, function(newValue)
...
VisualsTab:Toggle("路径点", "Waypoints", loadData.waypoints, function(newValue)
...
VisualsTab:Toggle("显示耙子信息", "Show_Rake_Info", loadData.showRakeInfo, function(newValue)
...
VisualsTab:Toggle("解锁第三人称视角", "Unlock_Third_Person", loadData.unlockThirdPerson, function(newValue)
...
ClientTab:Toggle("无跌落伤害", "No_Fall_Damage", loadData.noFallDamage, function(newValue)
...
ClientTab:Toggle("查看摄像头", "View_Cameras", loadData.viewCameras, function(newValue)
...
ClientTab:Toggle("计时器", "Timer", loadData.timer, function(newValue)
...
ClientTab:Toggle("能量等级", "Power_Level", loadData.powerLevel, function(newValue)
...
SupplyDropTab:Button("查看补给箱物品", "View_Supply_Drop_Items", function()
...
ToolsTab:Toggle("紫外线灯修改器", "UV_Lamp_Modifier", loadData.uvlampModifier, function(newValue)
...
ToolsTab:Toggle("眩晕棒光环", "Stun_Stick_Aura", loadData.stunstickAura, function(newValue)
...
ToolsTab:Toggle("手电筒修改器", "Flashlight_Modifier", loadData.flashlightModifier, function(newValue)
