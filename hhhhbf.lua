...
local library = loadstring(game:HttpGet("https://github.com/XGOHUBlIllIlIIIIlllllIIlIlIIIIIllllIIlL/IIIIllllIllliiiilllllllIlIlIlIlLXGXXXG/raw/main/XGOHUBlibrary.lua"))()
local window = library:new("【メ】【G】【Ö】【ℍ】【ⓤ】【ß】")
local Set = window:Tab("设置农场", '128885038925647')
local Main = window:Tab("自动农场", '128885038925647')
local Farm = window:Tab("物品任务", '128885038925647')
local Event = window:Tab("海洋事件", '128885038925647')
local Stats = window:Tab("自动状态", '128885038925647')
local Tele = window:Tab("世界传送", '128885038925647')
local Player = window:Tab("玩家PVP", '128885038925647')
local Race = window:Tab("竞速V4", '128885038925647')
local Raid = window:Tab("副本突袭", '128885038925647')
local DemonFruit = window:Tab("恶魔果实", '128885038925647')
local Esp = window:Tab("玩家ESP", '128885038925647')
local Shop = window:Tab("商店", '128885038925647')
local Misc = window:Tab("其他", '128885038925647')
-----------------------------------------------------------------------------------------------------------------------------Function
...
local Main = Main:section("主要农场", true)
...
local Main = Main:section("蛋糕农场", true)
...
local Main = Main:section("骨农场", true)
...
local Main = Main:section("精通农场", true)
...
local Main = Main:section("首领农场", true)
...
local Main = Main:section("怪物农场", true)
...
local Farm = Farm:section("精英猎人", true)
...
local Farm = Farm:section("观察之眼", true)
...
local Farm = Farm:section("传奇之剑", true)
...
local Farm = Farm:section("强化颜色", true)
...
local Farm = Farm:section("自动材料", true)
...
local Farm = Farm:section("自动剑", true)
...
local Farm = Farm:section("自动近战", true)
