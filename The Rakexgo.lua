...
xgo:Toggle({
    ["Title"] = "补给箱ESP",
    ["Content"] = "Supply_Drop_ESP",
    ["Default"] = loadData.supplydropESP,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "信号枪ESP",
    ["Content"] = "Flare_Gun_ESP",
    ["Default"] = loadData.flaregunESP,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "信号枪通知",
    ["Content"] = "Flare_Gun_Notifications",
    ["Default"] = loadData.flaregunNotification,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "始终夜晚",
    ["Content"] = "Always_Night",
    ["Default"] = loadData.alwaysNight,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "显示耙子信息",
    ["Content"] = "Show_Rake_Info",
    ["Default"] = loadData.showRakeInfo,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "解锁第三人称视角",
    ["Content"] = "Unlock_Third_Person",
    ["Default"] = loadData.unlockThirdPerson,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "无限体力",
    ["Content"] = "Infinite_Stamina",
    ["Default"] = loadData.infiniteStamina,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "无跌落伤害",
    ["Content"] = "No_Fall_Damage",
    ["Default"] = loadData.noFallDamage,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "查看摄像头",
    ["Content"] = "View_Cameras",
    ["Default"] = loadData.viewCameras,
    ["Callback"] = function(newValue)
...
xgo:TextInput({
    ["Title"] = "无体力消耗快跑",
    ["Content"] = "Sprint_without_Stamina",
...
xgo:Toggle({
    ["Title"] = "绕过补给箱锁定",
    ["Content"] = "Bypass_Supply_Drop_Lock",
    ["Default"] = loadData.bypassSupplyDropLock,
    ["Callback"] = function(newValue)
...
xgo:Button({
    ["Title"] = "查看补给箱物品",
    ["Content"] = "View_Supply_Drop_Items",
    ["Callback"] = function()
...
xgo:Toggle({
    ["Title"] = "眩晕棒修改器",
    ["Content"] = "Stun_Stick_Modifier",
    ["Default"] = loadData.stunstickModifier,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "紫外线灯修改器",
    ["Content"] = "UV_Lamp_Modifier",
    ["Default"] = loadData.uvlampModifier,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "眩晕棒光环",
    ["Content"] = "Stun_Stick_Aura",
    ["Default"] = loadData.stunstickAura,
    ["Callback"] = function(newValue)
...
xgo:Toggle({
    ["Title"] = "手电筒修改器",
    ["Content"] = "Flashlight_Modifier",
    ["Default"] = loadData.flashlightModifier,
    ["Callback"] = function(newValue)
