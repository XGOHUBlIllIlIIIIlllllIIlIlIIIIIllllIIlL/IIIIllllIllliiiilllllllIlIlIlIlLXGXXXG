...
-- Music Player Frame within the Main Frame

MusicPlayerFrame.Parent = MainFrame
MusicPlayerFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
MusicPlayerFrame.Size = UDim2.new(1, 0, 0, 100) -- Adjust the height as needed
MusicPlayerFrame.Position = UDim2.new(0, 0, 0, 0) -- Position it below the HomeScriptsFrame or other frames


MusicPlayerUICorner.Parent = MusicPlayerFrame
MusicPlayerUICorner.CornerRadius = UDim.new(0, 10)

-- Music Player Buttons and Labels within the MusicPlayerFrame

MusicTitle.Parent = MusicPlayerFrame
MusicTitle.Text = "Music Player"
MusicTitle.Font = Enum.Font.ArimoBold
MusicTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
MusicTitle.TextSize = 14
MusicTitle.Position = UDim2.new(0, 10, 0, 5)
MusicTitle.Size = UDim2.new(0, 100, 0, 20)


Stop_PlayButton.Parent = MusicPlayerFrame
...
Stop_PlayButton.Position = UDim2.new(0.5, -15, 0.5, 0)
Stop_PlayButton.Image = "rbxassetid://16139639068" -- Play button image
Stop_PlayButton.AutoButtonColor = false


SoundTextBox.Parent = MusicPlayerFrame
SoundTextBox.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
SoundTextBox.Size = UDim2.new(0, 200, 0, 20)
SoundTextBox.Position = UDim2.new(0.5, -100, 0.4, 0)
SoundTextBox.PlaceholderText = "Enter Sound Id"
SoundTextBox.TextColor3 = Color3.fromRGB(255, 255, 255)


SaveButton.Parent = MusicPlayerFrame
SaveButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
SaveButton.Size = UDim2.new(0, 30, 0, 30)
SaveButton.Position = UDim2.new(0.5, -15, 0.5, -20)
SaveButton.Image = "rbxassetid://3779036535" -- Save button image
SaveButton.AutoButtonColor = false


VolumeUpButton.Parent = MusicPlayerFrame
VolumeUpButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
VolumeUpButton.Size = UDim2.new(0, 30, 0, 30)
VolumeUpButton.Position = UDim2.new(0.8, 0, 0.5, 0)
VolumeUpButton.Image = "rbxassetid://16164520143" -- Volume up button image
VolumeUpButton.AutoButtonColor = false


VolumeDownButton.Parent = MusicPlayerFrame
VolumeDownButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
VolumeDownButton.Size = UDim2.new(0, 30, 0, 30)
VolumeDownButton.Position = UDim2.new(0.2, 0, 0.5, 0)
VolumeDownButton.Image = "rbxassetid://16164522333" -- Volume down button image
...
-- Event connections for the music player buttons
...
SaveButton.MouseButton1Click:Connect(function()
    local soundId = SoundTextBox.Text
    writefile("ECCS_V2.7/CoreSystem/Files/ECCSV3Player.ECCS", soundId)
end)
