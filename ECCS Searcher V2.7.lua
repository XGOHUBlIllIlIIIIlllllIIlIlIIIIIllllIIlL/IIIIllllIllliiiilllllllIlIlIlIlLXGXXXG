...
OpenCloseSearcherButton.MouseButton1Click:Connect(function()
    if XUI["_xgohub"].Visible then
        XUI["_xgohub"]:TweenSize(UDim2.new(0, 0, 0, 0), "Out", "Sine", 0.3)
        XUI["_xgohub"].Visible = false
    else
        XUI["_xgohub"]:TweenSize(UDim2.new(0, 500, 0, 450), "Out", "Sine", 0.3)
        XUI["_xgohub"].Visible = true
    end
end)
