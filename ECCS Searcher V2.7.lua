if game:GetService("CoreGui"):FindFirstChild("XGOGUI") then
HintWait.Size = UDim2.new(0, 0, 0, 60)
HintWait:TweenSize(UDim2.new(0, 250, 0, 60),"Out","Linear",3)
Hint.Text = " 已加载,重新加入即可执行" return end
HttpService = game:GetService("HttpService")
TweenService = game:GetService("TweenService")
XGOGUI = Instance.new("ScreenGui")
...
UINoScriptsFound.SoundId = "rbxassetid://7383525713"--音乐
...
HomeButton_2.Image = "rbxassetid://72187700093513"--房屋图像
...
TouchFlingButton_2.Image = "rbxassetid://126059767518621"--甩飞图像
...
AntiFlingButton_2.Image = "rbxassetid://112553298360396"--防甩飞图像
...
ExecutorButton_2.Image = "rbxassetid://74369261997103"--执行官图像</>
...
SearcherButton_2.Image = "rbxassetid://119784725955851"--搜索图像
...
SearcherSettingsButton_2.Image = "rbxassetid://106913268653015"--设置图像
...
OpenPaintButton_2.Image = "rbxassetid://140327683243681"--画笔图像
...
SearchBox_2.PlaceholderText = "     搜寻"
SearchBox_2.Text = ""
...
SearchBoxImg_2.Image = "rbxassetid://119784725955851"--搜索图像
...
OpenCloseSearcherButton.Parent = XGOGUI
...
OpenCloseSearcherButton.Image = "rbxassetid://128885038925647"--脚本开关按钮图像
...
MainFrame.ZIndex = 2
MainFrame.Image = "rbxassetid://128885038925647"--背景
...
InfoBoxDescription.Text = "这是一个描述!"
...
SearchBoxImg.Image = "rbxassetid://119784725955851"--搜索图像
...
ECCSSearcherSettingsButton.Image = "rbxassetid://106913268653015"--设置图像
...
HomeButton.Image = "rbxassetid://72187700093513"--房屋图像
...
DevIcon.Image = "https://www.roblox.com/headshot-thumbnail/image?userId=5675129870&width=999&height=999&format=png"--xgo游戏头像
...
AddPluginButtonImg.Image = "rbxassetid://109300103143672"--加号头像大
...
AddPluginTextBox.PlaceholderText = " 插件在这里..."
...
PushFlingImg.Image = "rbxassetid://9134785384"--目标标靶图像
...
ShadersImg.Image = "rbxassetid://82516178946307"--太阳图像
...
RejoinImg.Image = "rbxassetid://127998086674176"--云朵图像
...
AntiAfkImg.Image = "rbxassetid://129851370008578"--时钟图像
...
TouchFlingImg.Image = "rbxassetid://85283665776150"--甩飞图像两个人互推
...
AntiFlingImg.Image = "rbxassetid://72715163635410"--防甩飞图像防御盾
...
ExecutorMenuButton.Image = "rbxassetid://74369261997103"--执行官图像</>
...
ClearImg.Image = "rbxassetid://124009191904850"--复制错误图像
...
CopyImg.Image = "rbxassetid://116582203267610"--复制图像
...
ExecuteImg_3.Image = "rbxassetid://94761665022976"--行走图像
...
PasteImg.Image = "rbxassetid://117737254049060"--粘贴图像
...
OpenPaintButton.Image = "rbxassetid://140327683243681"--画笔图像
...
ClearCanvas.Image = "rbxassetid://132073176811949"--删除图像垃圾桶
...
Eraser.Image = "rbxassetid://108246232396065"--橡皮擦图像
...
Pencil.Image = "rbxassetid://103254268443636"--铅笔图像
...
SearcherMenuButton.Image = "rbxassetid://119784725955851"--搜索图像
...
KeySystemImg.Image = "rbxassetid://121862914614673"--钥匙图像
...
ExecuteImg_1.Image = "rbxassetid://94761665022976"--行走图像
...
ChatButton.Image = "rbxassetid://18132342746"--聊天图像
...
OIEImg_1.Image = "rbxassetid://107650144984351"--执行官图像</>
...
OIEImg_2.Image = "rbxassetid://107650144984351"--执行官图像</>
...
ChatButton_2.Image = "rbxassetid://18132342746"--聊天图像
...
KeySystemImg_2.Image = "rbxassetid://121862914614673"--钥匙图像
...
ExecuteImg_2.Image = "rbxassetid://94761665022976"--行走图像
...
RawImg_1.Image = "rbxassetid://116582203267610"--复制图像
...
RawImg_2.Image = "rbxassetid://116582203267610"--复制图像
...
LinkImg_1.Image = "rbxassetid://83413734162545"--复制链接图像
...
LinkImg_2.Image = "rbxassetid://83413734162545"--复制链接图像
...
ProfilePicture_2.Image = "rbxassetid://114910499491319"--不知道什么图像上面一个小圆下面一个大半圆
...
LikeImg.Image = "rbxassetid://89701383377844"--收藏图像 点赞
...
DislikeImg.Image = "rbxassetid://102306159253445"--收藏图像 不点赞
...
CloseSearcherSettingsButton.Text = "关"
...
CreateNewThemeImg.Image = "rbxassetid://109300103143672"--图像加号+
...
AquaThemeImg.Image = "rbxassetid://87037152011988"--类型创建图像
...
RustThemeImg.Image = "rbxassetid://87037152011988"--类型创建图像
...
DarkThemeImg.Image = "rbxassetid://87037152011988"--类型创建图像
...
SerikaThemeImg.Image = "rbxassetid://87037152011988"--类型创建图像
...
DeletePluginsImg.Image = "rbxassetid://87871075902725"--插头图像
...
DeleteFavoritesImg.Image = "rbxassetid://140134024072804"--五角星图像
...
DeleteHistoryImg.Image = "rbxassetid://118831113405601"--时钟闹钟头像
...
DeleteThemesImg.Image = "rbxassetid://87037152011988"--类型创建图像
...
CustomThemeImg.Image = "rbxassetid://87037152011988"--类型创建图像
...
return
game:HttpGet("https://i.ibb.co/x6Y5GtM/IMG-20241108-021205.jpg")
end)
 
if success then
MainImageURl = "https://i.ibb.co/x6Y5GtM/IMG-20241108-021205.jpg"
...
MainFrame.Image = "rbxassetid://127287682439217"--蓝色糖果图像
end
...
while wait() do
local ButtonImages = ({
["01 01"] = "rbxassetid://130593481358109",--烟花图像
[(function(Year)
...
end)(tonumber(os.date"%Y"))] = "rbxassetid://100058723340315",--不明图像 蓝红黄
["10 31"] = "rbxassetid://102482922102785",--南瓜图像
["12 25"] = "rbxassetid://112729707340653"--圣诞树图像
})[os.date("%m %d")]
...
PushFlingTool.TextureId = "rbxassetid://9134785384"--目标靶图像
...
newScript.SImg.Image = "https://assetgame.roblox.com/Game/Tools/ThumbnailAsset.ashx?aid="..v.game.gameId.."&fmt=png&wd=420&ht=420"
           ...
           ScriptImg.Image = newScript.SImg.Image
            ...
            HeadFrame:TweenPosition(UDim2.new(-0.5, 0, 0, 0),"InOut","Sine",0.3)
            InfoBoxDescription.Text = v.features or " API错误!"
            end)
...
-- ECCS Searcher V2.7.txt
-- 省略其他代码...

-- 音乐播放器标题栏
local MusicTitleBar = Instance.new("Frame")
MusicTitleBar.Parent = XGOGUI
MusicTitleBar.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
MusicTitleBar.Size = UDim2.new(0, 400, 0, 30)
MusicTitleBar.Position = UDim2.new(0.5, -200, 0, 0)
MusicTitleBar.BorderSizePixel = 0

local MusicTitleText = Instance.new("TextLabel")
MusicTitleText.Parent = MusicTitleBar
MusicTitleText.Text = "Music Player"
MusicTitleText.TextColor3 = Color3.fromRGB(255, 255, 255)
MusicTitleText.Size = UDim2.new(1, 0, 1, 0)
MusicTitleText.Position = UDim2.new(0, 0, 0, 0)
MusicTitleText.Font = Enum.Font.ArimoBold
MusicTitleText.TextSize = 14
MusicTitleText.TextXAlignment = Enum.TextXAlignment.Center
...
Stop_PlayButton.Parent = XGOGUI
Stop_PlayButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Stop_PlayButton.Size = UDim2.new(0, 30, 0, 30)
Stop_PlayButton.Position = UDim2.new(0.5, -15, 0.5, 45)
Stop_PlayButton.Image = "rbxassetid://16139639068" -- 播放按钮图片
Stop_PlayButton.AutoButtonColor = false

local AudioName = Instance.new("TextLabel")
AudioName.Name = "AudioName"
AudioName.Parent = XGOGUI
AudioName.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
AudioName.Size = UDim2.new(0, 200, 0, 20)
AudioName.Position = UDim2.new(0.5, -100, 0.5, 60)
AudioName.Text = ""
AudioName.TextColor3 = Color3.fromRGB(255, 255, 255)

local SoundTextBox = Instance.new("TextBox")
SoundTextBox.Name = "SoundTextBox"
SoundTextBox.Parent = XGOGUI
SoundTextBox.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
SoundTextBox.Size = UDim2.new(0, 200, 0, 20)
SoundTextBox.Position = UDim2.new(0.5, -100, 0.5, 15)
...
SaveButton_2.Parent = XGOGUI
SaveButton_2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
SaveButton_2.Size = UDim2.new(0, 30, 0, 30)
SaveButton_2.Position = UDim2.new(0.5, -15, 0.5, 75)
SaveButton_2.Image = "rbxassetid://16139574980" -- 保存按钮图片
SaveButton_2.AutoButtonColor = false

local PlaylistButton = Instance.new("ImageButton")
PlaylistButton.Name = "PlaylistButton"
PlaylistButton.Parent = XGOGUI
PlaylistButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
PlaylistButton.Size = UDim2.new(0, 30, 0, 30)
PlaylistButton.Position = UDim2.new(0.5, -50, 0.5, 75)
PlaylistButton.Image = "rbxassetid://16139588106" -- 播放列表按钮图片
PlaylistButton.AutoButtonColor = false

local VolumeUpButton = Instance.new("ImageButton")
VolumeUpButton.Name = "VolumeUpButton"
VolumeUpButton.Parent = XGOGUI
VolumeUpButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
VolumeUpButton.Size = UDim2.new(0, 30, 0, 30)
VolumeUpButton.Position = UDim2.new(0.5, -85, 0.5, 75)
VolumeUpButton.Image = "rbxassetid://16164520143" -- 音量增加按钮图片
...
VolumeDownButton.Parent = XGOGUI
VolumeDownButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
VolumeDownButton.Size = UDim2.new(0, 30, 0, 30)
VolumeDownButton.Position = UDim2.new(0.5, -120, 0.5, 75)
VolumeDownButton.Image = "rbxassetid://16164522333" -- 音量减少按钮图片
