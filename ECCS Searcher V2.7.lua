...
SoundTextBox.Position = UDim2.new(0.5, -100, 0.5, -100)
SoundTextBox.Size = UDim2.new(0, 200, 0, 30)
SoundTextBox.ClearTextOnFocus = false
SoundTextBox.Font = Enum.Font.ArimoBold
...
PlayButton.Parent = XGOGUI
PlayButton.BackgroundColor3 = Color3.fromRGB(66, 170, 255)
PlayButton.Position = UDim2.new(0.5, 50, 0.5, -50)
PlayButton.Size = UDim2.new(0, 100, 0, 30)
PlayButton.AutoButtonColor = false
PlayButton.Font = Enum.Font.ArimoBold
...
PlayButton.MouseButton1Click:Connect(function()
    ...
    if SoundId ~= "" then
        ...
        HintWait.Size = UDim2.new(0, 0, 0, 60)
        HintWait:TweenSize(UDim2.new(0, 250, 0, 60),"Out","Linear",3)
        Hint.Text = " Please enter a valid sound id."
    end
end)

-- Rest of the V2.7 Code
-- [Omitted for brevity, include all the rest of the V2.7 code here]
