...
MusicFrame.Parent = MenuBarFrame
MusicFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
MusicFrame.Size = UDim2.new(0, 50, 0, 45)
MusicFrame.Position = UDim2.new(0.5, 0, 0.18, 0)
MusicFrame.BorderSizePixel = 0

local MusicFrameUICorner = Instance.new("UICorner")
MusicFrameUICorner.Parent = MusicFrame
MusicFrameUICorner.CornerRadius = UDim.new(0, 10)

local MusicButton = Instance.new("ImageButton")
MusicButton.Parent = MusicFrame
MusicButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
MusicButton.Size = UDim2.new(1, 0, 1, 0)
MusicButton.Position = UDim2.new(0, 0, 0, 0)
MusicButton.Image = "rbxassetid://15996975276" -- 音乐播放器图标
MusicButton.AutoButtonColor = false

-- 音乐播放器UI代码
local MusicUI = Instance.new("Frame")
MusicUI.Parent = XGOGUI
MusicUI.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
MusicUI.Size = UDim2.new(0, 400, 0, 100)
MusicUI.Position = UDim2.new(0.5, -200, 0.4, 0)
MusicUI.BorderSizePixel = 0

local MusicUICorner = Instance.new("UICorner")
MusicUICorner.Parent = MusicUI
MusicUICorner.CornerRadius = UDim.new(0, 10)

local Stop_PlayButton = Instance.new("ImageButton")
Stop_PlayButton.Parent = MusicUI
Stop_PlayButton.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Stop_PlayButton.Size = UDim2.new(0, 30, 0, 30)
Stop_PlayButton.Position = UDim2.new(0.025, 0, 0.4, 0)
...
SoundTextBox.Parent = MusicUI
SoundTextBox.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
SoundTextBox.Size = UDim2.new(0, 200, 0, 30)
SoundTextBox.Position = UDim2.new(0.4, 0, 0.4, 0)
...
Stop_PlayButton.MouseButton1Click:Connect(function()
    if Stop_PlayButton.Image == "rbxassetid://16139639068" then
        ...
        CoreSound.SoundId = "rbxassetid://"..soundId
        CoreSound:Play()
    else
...
SaveButton.MouseButton1Click:Connect(function()
    local soundId = SoundTextBox.Text
    writefile("ECCS_V3/CoreSystem/Files/ECCSV3Player.ECCS", soundId)
end)
