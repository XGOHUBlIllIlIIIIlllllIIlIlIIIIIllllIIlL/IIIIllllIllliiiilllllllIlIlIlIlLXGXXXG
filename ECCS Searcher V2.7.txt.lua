...
DevelopersButton = Instance.new("TextButton")--修改
DevelopersButtonUICorner = Instance.new("UICorner")--1
PlayerIcon = Instance.new("ImageButton")--2
PlayerIconUICorner = Instance.new("UICorner")--3
ReloadPlayerDataButton = Instance.new("TextButton")--4
ReloadPlayerDataButtonUICorner = Instance.new("UICorner")--5
CopyPlayerDataButton = Instance.new("TextButton")--6
CopyPlayerDataButtonUICorner = Instance.new("UICorner")--7
