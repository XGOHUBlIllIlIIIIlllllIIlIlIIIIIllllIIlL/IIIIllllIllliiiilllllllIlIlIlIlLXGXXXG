...
xgo:Button({Title="Mp3外置音乐连接器\n点击下面复制网址",Content ="",Callback = function()loadstring(game:HttpGet("https://raw.githubusercontent.com/Dan41/Scripts/refs/heads/main/GITHUB%20AUDIO%20PLAYER.lua"))()end})
local function createButton(title, callback)return xgo:Button({Title = title,Content = "",Callback = callback})end
