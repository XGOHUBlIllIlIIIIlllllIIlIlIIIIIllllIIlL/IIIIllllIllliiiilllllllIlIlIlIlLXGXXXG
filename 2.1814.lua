...
local Seperator = Section:Seperator(             "ฅ〈三大安全函数〉ฅ")
...
local Seperator = Section:Seperator("ฅDjฅ")
...
local Seperator = Section:Seperator("ฅ休闲安逸嗯，更新这个音乐系统的话，我也不知道具体什么时间ฅ") 
...
local Seperator = Section:Seperator("ฅ整蛊语音还有一些梗xgo找这些好辛苦的ฅ")
...
local Section = LeisureTab:Section({Title = "x-ฅ每点击+1车辆ฅ",    Content = "ฅ休闲-每点击+1车辆ฅ"})
...
Section:Button({Title ="xgo制作", ["Content"] = "",  Callback = function()        loadstring(gamฅe:HttpGet(("https://raw.githubusercontent.com/GTAFAW/goto/refs/heads/main/xgo%E5%B1%A0%E5%AE%B0%E5%9C%BA%5B%E6%81%90%E6%80%96%5D.lua")))()    end})
