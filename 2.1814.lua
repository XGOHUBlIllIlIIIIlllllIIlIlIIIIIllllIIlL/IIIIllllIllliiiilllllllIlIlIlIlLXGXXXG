...
local StrategywarTab = sitinkgui:MakeTab("x-游戏-策略战争")
local StruggleTab = sitinkgui:MakeTab("x-游戏-拳击")
...
local Section = StrategywarTab:Section({    Title = "x-策略战争",    Content = "在更新"})

local Section = StruggleTab:Section({    Title = "x-最强战场",    Content = "拳击-最强战场"})
...
local Section = DrivingTab:Section({    Title = "x-载具驾驶",    Content = "待更新"})
...
local Section = RNGTab:Section({    Title = "x- RNG",    Content = "待更新"})
