...
Section:Button({Title = "玩家名牌查看",	Content ="",	Callback = function()        loadstring(game:HttpGet("https://pastebin.com/raw/PYjMaUj5"))()   end})
Section:Button({Title = "信息查看",	Content ="",	Callback = function()        loadstring(game:HttpGet("https://pastebin.com/raw/mqrZCSm9"))()   end})
...
local Section = LeisureTab:Section({Title = "x-每点击+1车辆",    Content = "休闲-每点击+1车辆"})
...
local Section = LeisureTab:Section({    Title = "x-后悔电梯",    Content = "模拟器-后悔电梯"})
...
local Section = HorrorTab:Section({    Title = "x-奶奶:多人游戏",    Content = "恐怖-恐怖奶奶"})
...
local Section = AsymmetriccompetitiveTab:Section({Title = "x-破坏者谜团2",    Content = "破坏者谜团"})
...
local Section = DrivingTab:Section({Title = "x-Vehicle Legends",    Content = "Vehicle Legends"})
...
local Section = DrivingTab:Section({Title = "x-河北唐县",    Content = "河北唐县"})
...
local Section = LeisureTab:Section({    Title = "x-小猫游戏",    Content = "休闲-小猫游戏"})
