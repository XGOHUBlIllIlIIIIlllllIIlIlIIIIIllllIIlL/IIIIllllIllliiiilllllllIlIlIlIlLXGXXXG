...
local ShotTab = sitinkgui:MakeTab("x-游戏-射击")
local DrivingTab = sitinkgui:MakeTab("x-游戏-载具驾驶")
local SandboxconstructionTab = sitinkgui:MakeTab("x-游戏-沙盒建造")
local RoleplayTab = sitinkgui:MakeTab("x-游戏-角色扮演（RPG）")
...
local Section = SimulationbusinessTab:Section({    Title = "x-模拟经营",    Content = "待更新"})
...
local Section = ShotTab:Section({Title = "x-俄亥俄州",    Content = "射击-俄亥俄州"})
...
local Section = ShotTab:Section({    Title = "x-兵工厂",    Content = "射击-兵工厂"})
...
local Section = ShotTab:Section({    Title = "x-战争大亨",    Content = "射击-战争大亨"})
...
local Section = SandboxconstructionTab:Section({Title = "x-沙盒建造",    Content = "待更新"})

local Section = RoleplayTab:Section({Title = "x-角色扮演",    Content = "待更新"})
...
Section:Button({Title ="小go主页",["Content"] = "",  Callback = function()    loadstring(game:HttpGet("https://raw.githubusercontent.com/lIlIlIlIlI24568/14362llll364XXGOLLLk22222/refs/heads/main/goto"))()  end})
