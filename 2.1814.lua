...
local ActionsimulationTab = sitinkgui:MakeTab("x-游戏-动作模拟")
...
local Section = ActionadventureTab:Section({    Title = "x-动作冒险",    Content = "待更新"})
...
local Section = ActionsimulationTab:Section({Title = "x-动作冒险",    Content = "待更新"})
