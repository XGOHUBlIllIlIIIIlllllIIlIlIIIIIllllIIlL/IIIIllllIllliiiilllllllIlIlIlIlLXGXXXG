...
local LeisureTab = sitinkgui:MakeTab("x-游戏-休闲模拟器")
local SimulationbusinessTab = sitinkgui:MakeTab("x-游戏-模拟经营")
local ActionadventureTab = sitinkgui:MakeTab("x-游戏-动作冒险")
local ShotTab = sitinkgui:MakeTab("x-游戏-枪战")
local StruggleTab = sitinkgui:MakeTab("x-游戏-战争")
local HorrorTab = sitinkgui:MakeTab("x-游戏-恐怖")
local AudioTab = sitinkgui:MakeTab("x-游戏-音游")
local AsymmetriccompetitiveTab = sitinkgui:MakeTab("x-游戏-非对称竞技")
local TowerDefenseTab = sitinkgui:MakeTab("x-游戏-塔防")
local DrivingTab = sitinkgui:MakeTab("x-游戏-载具驾驶")
local ParkourTab = sitinkgui:MakeTab("x-游戏-跑酷obby")
local RNGTab = sitinkgui:MakeTab("x-游戏-创意玩法（RNG）")
local ScriptTab = sitinkgui:MakeTab("x-其他脚本")
...
Section:Button({Title  ="goto飞行",     Content ="飞行",    	Callback = function()     loadstring(game:HttpGet("https://pastebin.com/raw/rtbZ0mBW"))()    end})
...
Section:Button({Title  = "聊天记录",	Content ="", 	Callback = function()       loadstring(game:HttpGet("https://pastebin.com/raw/bnQY7zVJ"))()    end})
...
Section:Button({Title ="自瞄",  ["Content"] = "1",  Callback = function()      loadstring(game:HttpGet("https://raw.githubusercontent.com/uFelikxs/Azure-Hub/main/AimBot.lua"))()    end})
Section:Button({Title = "自瞄",	["Content"] = "2",  Callback = function()         loadstring(game:HttpGet("https://pastebin.com/raw/gXsy4tYU"))()     end})
Section:Button({Title = "自瞄ui",	["Content"] = "3",  Callback = function()      loadstring(game:HttpGet("https://raw.githubusercontent.com/lIlIlIlIlI24568/114514.IIjjjjiiiallloiia.xxxxg/refs/heads/main/zm"))()    end})
Section:Button({Title = "自瞄ui2.0",	["Content"] = "4",  Callback = function()      loadstring(game:HttpGet("https://raw.githubusercontent.com/lIlIlIlIlI24568/111111/refs/heads/main/%E8%BE%85%E5%8A%A9%E7%9E%84%E5%87%86"))()    end}) 
...
Section:Button({Title ="框架彩色",  ["Content"] = "",  Callback = function()  local Players = game:GetService("Players")      local RunService = game:GetService("RunService")    local Camera = workspace.CurrentCamera     local LocalPlayer = Players.LocalPlayer    local function CreateESP(player)    local Box = Drawing.new("Square")    Box.Visible, Box.Thickness, Box.Filled = false, 4, false    local hue = 0    RunService.RenderStepped:Connect(function()        if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then            local HumanoidRootPart = player.Character.HumanoidRootPart           local pos, onScreen = Camera:WorldToViewportPoint(HumanoidRootPart.Position)            if onScreen then               Box.Size, Box.Position = Vector2.new(2000 / pos.Z, 2500 / pos.Z), Vector2.new(pos.X - Box.Size.X / 2, pos.Y - Box.Size.Y / 2)                Box.Visible = true                if not player.Team or not LocalPlayer.Team then                    Box.Color = Color3.fromHSV(hue, 1, 1)                   hue = (hue + 0.01) % 1                else                    Box.Color = player.Team == LocalPlayer.Team and Color3.new(0, 0, 1) or Color3.new(1, 0, 0)                end            else               Box.Visible = false            end        else            Box.Visible = false       end    end)end    local function ApplyPlayerESP()    for _, player in pairs(Players:GetPlayers()) do        if player ~= LocalPlayer then           CreateESP(player)        end    end    Players.PlayerAdded:Connect(function(player)        player.CharacterAdded:Connect(function()            CreateESP(player)        end)    end)end    while true do    ApplyPlayerESP()    wait(5)   end  end})
...
Section:TextInput({["Title"]= "范围修改",	["Place Holder Text"] = "数值",  ["Clear Text On Focus"] = false,	Callback = function(v) 	  local Players = game:GetService("Players")  local RunService = game:GetService("RunService")   local LocalPlayer = Players.LocalPlayer     local newSize = v     local function ChangeHitboxSize(size)    for _, player in pairs(Players:GetPlayers()) do        if player ~= LocalPlayer and player.Character and player.Character:FindFirstChild("HumanoidRootPart") then            local HumanoidRootPart = player.Character.HumanoidRootPart           local newHitboxSize = Vector3.new(size, size, size)            HumanoidRootPart.Size = newHitboxSize            HumanoidRootPart.Transparency = 0.5            HumanoidRootPart.CanCollide = false            local hue = 0            RunService.RenderStepped:Connect(function()                hue = (hue + 0.01) % 1                HumanoidRootPart.Color = Color3.fromHSV(hue, 1, 1)            end)        end    end   end  while true do  ChangeHitboxSize(newSize)    wait(5)   end  end})
...
local Section = LeisureTab:Section({    Title = "x-法宝模拟器",    Content = "模拟器-法宝模拟器"})
Section:Button({Title ="法宝模拟器",  ["Content"] = "1",  Callback = function()	loadstring(game:HttpGet('https://raw.githubusercontent.com/zhanghuihuihuil/Script/main/%E6%B3%95%E5%AE%9D%E6%A8%A1%E6%8B%9F%E5%99%A8%E6%B1%89%E5%8C%96'))()	end})
Section:Button({Title ="法宝模拟器",["Content"] = "2",  Callback = function()	loadstring(game:HttpGet("https://pastefy.app/9bGpv4H3/raw"))()	end})
Section:Button({Title ="法宝自动刷（任何地方）",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/cbhlyy/lyycbh/main/fabao"))()  	end})
local Section = SimulationbusinessTab:Section({    Title = "x-餐厅大亨2",    Content = "经营-餐厅大亨2"})
Section:Button({Title ="小go",["Content"] = "",  Callback = function()      loadstring(game:HttpGet(("https://raw.githubusercontent.com/lIlIlIlIlI24568/114514.IIjjjjiiiallloiia.xxxxg/refs/heads/main/%E9%A4%90%E5%8E%85%E5%A4%A7%E4%BA%A82")))()end})
Section:Button({Title ="zeld  Hub",["Content"] = "",  Callback = function()      loadstring(game:HttpGet("https://raw.githubusercontent.com/iz037/Zeld-Hub/main/Script/Restaurant%20Tycoon%202.lua"))()end})
Section:Button({Title ="Eclipse Hub",["Content"] = "",  Callback = function()     getgenv().mainKey = "nil"     local a,b,c,d,e=loadstring,request or http_request or (http and http.request) or (syn and syn.request),assert,tostring,"https://api.eclipsehub.xyz/auth"c(a and b,"Executor not Supported")a(b({Url=e.."\?\107e\121\61"..d(mainKey),Headers={["User-Agent"]="Eclipse"}}).Body)()     loadstring(game:HttpGet("https://raw.githubusercontent.com/OneProtocol/Project/main/Loader", true))()end})
local Section = SimulationbusinessTab:Section({    Title = "x-我的餐厅",    Content = "经营-我的餐厅"})
Section:Button({Title ="我的餐厅",["Content"] = "",  Callback = function()   loadstring(game:HttpGet("https://pastefy.app/5R1Ch6kk/raw"))()end})
local Section = ActionadventureTab:Section({Title = "x-Blox Fruits",    Content = "冒险-bf"})
...
Section:Button({Title ="run.mocky.io v3",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://run.mocky.io/v3/200db50e-2896-4060-86c1-29146e1ea6e0"))()		end})
Section:Button({Title ="mbmxhub",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/m1M-Plqer819/any/main/mbmxhub/0135"))()		end})
Section:Button({Title ="Master Hub",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/onepicesenpai/onepicesenpai/main/onichanokaka"))()		end})
Section:Button({Title ="RadonHub",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/x2-Neptune/RadonHub/main/Script.lua"))()		end})
Section:Button({Title ="MinGaming Hub",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/Basicallyybeta/mingane/main/MinGamingNew.lua"))()	end})
Section:Button({Title ="Fai-Fao",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/PNguyen0199/Script/main/Fai-Fao.lua"))()	end})
Section:Button({Title ="菜单版",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/Bebo-Mods/BeboScripts/main/MichaelZombies.lua"))()	end})
Section:Button({Title = "Tiger-Hub",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/plutoguy/Tiger-Hub/main/bloxfruits.lua"))()	end})
Section:Button({Title ="Speed-Hub-X",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/AhmadV99/Speed-Hub-X/main/Speed%20Hub%20X.lua"))()	end})
Section:Button({Title ="Steep1",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/LOLking123456/Steep1/main/Steps121"))()		end})
Section:Button({Title ="Infinite Hub",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/mkhoidzvl13/Infinite-Hub/main/Infinite.txt"))()		end})
Section:Button({Title ="OMG Hub",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/Omgshit/Scripts/main/MainLoader.lua"))()		end})
Section:Button({Title ="Rise Hub",["Content"] = "",  Callback = function()	loadstring(game:HttpGet("https://raw.githubusercontent.com/TrashLua/BloxFruits/main/FreeScripts.lua"))()		end})
local Section = ShotTab:Section({Title = "x-俄亥俄州",    Content = "枪战-俄亥俄州"})
...
local Section = ShotTab:Section({    Title = "x-兵工厂",    Content = "枪战-兵工厂"})
Section:Button({Title ="兵工厂",  ["Content"] = "1",  Callback = function()  loadstring(game:HttpGet('https://raw.githubusercontent.com/1201for/V.G-Hub/main/V.Ghub'))()    end})
Section:Button({Title ="兵工厂",["Content"] = "2",  Callback = function()  loadstring(game:HttpGet(('https://raw.githubusercontent.com/RandomAdamYT/DarkHub/master/Init'), true))()   end})
local Section = ShotTab:Section({    Title = "x-战争大亨",    Content = "枪战-战争大亨"})
Section:Button({Title ="破解无密钥",["Content"] = "",  Callback = function() loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Margman/whynot/main/oil%20warfare%20tycoon%20autofarm"))()   end})
Section:Button({Title ="剑客v4",["Content"] = "需进群组",  Callback = function()    jianke_V4 = "作者_初夏"jianke__V4 = "作者QQ1412152634"jianke___V4 = "剑客QQ群347724155"loadstring(game:HttpGet(('https://raw.githubusercontent.com/JianKeCX/JianKeV4/main/ChuXia')))()  end})
Section:Button({Title ="小go战争大亨",["Content"] = "",  Callback = function()  loadstring(game:HttpGet(("https://raw.githubusercontent.com/lIlIlIlIlI24568/114514.IIjjjjiiiallloiia.xxxxg/refs/heads/main/%E6%88%98%E4%BA%89%E5%A4%A7%E4%BA%A8")))() end})
local Section = StruggleTab:Section({Title = "x-最强战场",    Content = "战争-最强战场"})
...
local Section = StruggleTab:Section({    Title = "x-地下战争2.0",    Content = "战争-地下战争2.0"})
Section:Button({Title ="小go汉化", ["Content"] = "",  Callback = function() loadstring(game:HttpGet(("https://raw.githubusercontent.com/lIlIlIlIlI24568/zxcvb/refs/heads/main/bad%20undergroundwar%202")))()    end})
local Section = StruggleTab:Section({    Title = "x-旗帜战争",    Content = "战争-旗帜战争"})
Section:Button({Title ="旗帜战争",["Content"] = "2",  Callback = function()      loadstring(game:HttpGet('https://raw.githubusercontent.com/Infinity2346/Tect-Menu/main/Flag%20Wars.txt'))()end})
...
local Section = HorrorTab:Section({    Title = "x-The rake重置版",    Content = "恐怖-rake重置版"})
Section:Button({Title ="rake",  ["Content"] = "1",  Callback = function()  loadstring(game:HttpGet("https://raw.githubusercontent.com/lIlIlIlIlI24568/114514.IIjjjjiiiallloiia.xxxxg/refs/heads/main/rake1"))()      end})
Section:Button({Title ="rake",  ["Content"] = "2",  Callback = function()    loadstring(game:HttpGet("https://raw.githubusercontent.com/Unknownlodfc/Zephyr/refs/heads/main/Zephyr%20%7C%20The%20Rake%20Remastered"))()   end})
local Section = HorrorTab:Section({    Title = "x-屠宰场[恐怖]",    Content = "恐怖-屠宰场"})
Section:Button({Title ="xgo制作", ["Content"] = "",  Callback = function()        loadstring(game:HttpGet(("https://raw.githubusercontent.com/GTAFAW/goto/refs/heads/main/xgo%E5%B1%A0%E5%AE%B0%E5%9C%BA%5B%E6%81%90%E6%80%96%5D.lua")))()    end})
local Section = HorrorTab:Section({    Title = "x-保姆[恐怖]",    Content = "恐怖-保姆"})
Section:Button({Title ="xgo制作", ["Content"] = "",  Callback = function()       loadstring(game:HttpGet(("https://raw.githubusercontent.com/GTAFAW/goto/refs/heads/main/xgo%E4%BF%9D%E5%A7%86%5B%E6%81%90%E6%80%96%5D.txt")))()   end})
local Section = HorrorTab:Section({    Title = "x-弗雷德的厄运",    Content = "恐怖-弗雷德的厄运"})
Section:Button({Title ="xgo制作", ["Content"] = "",  Callback = function()        loadstring(game:HttpGet(("https://raw.githubusercontent.com/GTAFAW/goto/refs/heads/main/xgo%20Five%20Nights%20At%20Freddy%20s%20Doom%E5%BC%97%E9%9B%B7%E5%BE%B7%E7%9A%84%E5%8E%84%E8%BF%90.txt")))()  end})
local Section = HorrorTab:Section({    Title = "x-住宅大屠杀",    Content = "恐怖-住宅大屠杀"})
Section:Button({Title ="住宅大屠杀小go二改",   ["Content"] = "",  Callback = function()        loadstring(game:HttpGet("https://raw.githubusercontent.com/lIlIlIlIlI24568/114514.IIjjjjiiiallloiia.xxxxg/refs/heads/main/%E4%BD%8F%E5%AE%85%E5%A4%A7%E5%B1%A0%E6%9D%80"))()    end})
local Section = AudioTab:Section({Title = "x-音游",    Content = "待更新"})

local Section = AsymmetriccompetitiveTab:Section({Title = "x-非对称竞技",    Content = "待更新"})

local Section = TowerDefenseTab:Section({Title = "x-塔防",    Content = "待更新"})

local Section = DrivingTab:Section({Title = "x-出租车司机",    Content = "出租车司机"})
Section:Button({Title ="xgo制作", ["Content"] = "",  Callback = function()    loadstring(game:HttpGet(("https://raw.githubusercontent.com/GTAFAW/goto/refs/heads/main/xgo%20%E5%87%BA%E7%A7%9F%E8%BD%A6%E5%8F%B8%E6%9C%BATaxi.lua")))()  end})
local Section = ParkourTab:Section({Title = "x-跑酷",    Content = "待更新"})


local Section = RNGTab:Section({Title = "x-索尔的RNG",    Content = "RNG-索尔的RNG"})
Section:Button({Title = "索尔的RNG",  ["Content"] = "1",  Callback = function()   loadstring(game:HttpGet("https://raw.githubusercontent.com/Looser3itx/Hmmmmmmmmmmmmmmmmmmmmmmmmmmmm/main/loader.lua"))()   end})
