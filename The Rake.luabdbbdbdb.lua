...
function indexFlareGun()
	...
	if FlareGunInWorkspace then
		if not FlareGunInWorkspace:FindFirstChild("Isguied") then
			ESP(FlareGunInWorkspace, "信号枪", true)
...
ClientTab:Toggle({["Title"]="穿墙",["Default"] = false,["Callback"] = function(Noclip)
			while Noclip do
