...
local Tap = {
    General = Window:AddTab({Title = "常规", Icon = "box"}),
    Event = Window:AddTab({Title = "事件", Icon = "star"}),
    Player = Window:AddTab({Title = "玩家", Icon = "user"}),
    Shop = Window:AddTab({Title = "商店", Icon = "shopping-bag"}),
    Configs = Window:AddTab({Title = "配置", Icon = "diamond"}),
    Teleport = Window:AddTab({Title = "传送", Icon = "asterisk"}),
...
["footer"]= {
["text"]  = "Remoralz Notify",
["icon_url"] = "https://cdn.discordapp.com/attachments/1256337309356261488/1307093289115189308/IMG_20241115_231713.jpg?ex=67390cfc&is=6737bb7c&hm=08128838c7050ecb85897179f7ad069dbf3cbec46ae4adb1bb73928dfcc8b19e&"
}
}
}
})
...
InterfaceManager:SetFolder("Remoralz")
